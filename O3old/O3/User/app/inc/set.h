...
#define CHECKSTARTTIME        120    //起始的时间  单位S
#define CHECKL1TIME           180    //自检阶段最高湿度延时时间
#define CHECKL2TIME           120    //自检阶段第二湿度延时时间
#define CHECKL3TIME           30     //自检阶段第三最高湿度延时时间
...
#define AUTOVCALTIME   120     //修改这个宏，改变自动体积模式下每次计算参数的间隔时间
