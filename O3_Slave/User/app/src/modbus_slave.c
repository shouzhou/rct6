...
void MODS_ReciveNew(uint8_t _byte)
{
  ...
  //  timeout = 800000000 / SBAUD485;			/* 计算超时时间，单位us 35000000*/
...
static uint8_t MODS_ReadRegValue(uint16_t reg_addr, uint8_t *reg_value)
{
	...
	switch (reg_addr)									/* 判断寄存器地址 */
	{
        ...
        case SLAVE_REG_P09:
			...
			break;
        case SLAVE_REG_P10:
			value =	g_tVar.P10;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P11:
			value =	g_tVar.P11;							/* 将寄存器值读出 */
			break;
        		case SLAVE_REG_P12:
			value =	g_tVar.P12;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P13:
			value =	g_tVar.P13;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P14:
			value =	g_tVar.P14;							/* 将寄存器值读出 */
			break;
        		case SLAVE_REG_P15:
			value =	g_tVar.P15;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P16:
			value =	g_tVar.P16;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P17:
			value =	g_tVar.P17;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P18:
			value =	g_tVar.P18;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P19:
			value =	g_tVar.P19;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P20:
			value =	g_tVar.P20;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P21:
			value =	g_tVar.P21;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P22:
			value =	g_tVar.P22;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P23:
			value =	g_tVar.P23;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P24:
			value =	g_tVar.P24;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P25:
			value =	g_tVar.P25;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P26:
			value =	g_tVar.P26;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P27:
			value =	g_tVar.P27;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P28:
			value =	g_tVar.P28;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P29:
			value =	g_tVar.P29;							/* 将寄存器值读出 */
			break;
        case SLAVE_REG_P30:
			value =	g_tVar.P30;							/* 将寄存器值读出 */
			break;
...
static uint8_t MODS_WriteRegValue(uint16_t reg_addr, uint16_t reg_value)
{
	...
	{	
		...
		case SLAVE_REG_P02:
			...
			break;
        case SLAVE_REG_P03:
			g_tVar.P03 = reg_value;				/* 将值写入保存寄存器 */
			break;
		
		case SLAVE_REG_P04:
			g_tVar.P04 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P05:
		...
		case SLAVE_REG_P06:
			...
			break;
        case SLAVE_REG_P07:
			g_tVar.P07 = reg_value;				/* 将值写入保存寄存器 */
			break;
		
		case SLAVE_REG_P08:
			g_tVar.P08 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P09:
			g_tVar.P09 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P10:
			g_tVar.P10 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P11:
			g_tVar.P11 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P12:
			g_tVar.P12 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P13:
			g_tVar.P13 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P14:
			g_tVar.P14 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P15:
			g_tVar.P15 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P16:
			g_tVar.P16 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P17:
			g_tVar.P17 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P18:
			g_tVar.P18 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P19:
			g_tVar.P19 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P20:
			g_tVar.P20 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P21:
			g_tVar.P21 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P22:
			g_tVar.P22 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P23:
			g_tVar.P23 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P24:
			g_tVar.P24 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P25:
			g_tVar.P25 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P26:
			g_tVar.P26 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P27:
			g_tVar.P27 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P28:
			g_tVar.P28 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P29:
			g_tVar.P29 = reg_value;				/* 将值写入保存寄存器 */
			break;
        case SLAVE_REG_P30:
			g_tVar.P30 = reg_value;				/* 将值写入保存寄存器 */
			break;
