...
//#define GPIO_PIN_K5	    GPIO_Pin_8

//#define GPIO_PORT_K6    GPIOF
//#define GPIO_PIN_K6	    GPIO_Pin_8

//#define GPIO_PORT_K7    GPIOF
//#define GPIO_PIN_K7	    GPIO_Pin_8

//#define GPIO_PORT_K8    GPIOF
//#define GPIO_PIN_K8	    GPIO_Pin_8
...
static uint8_t IsKeyDown5(void) {if (IsKeyDown1() && IsKeyDown2()) return 1;else return 0;}		/* K1 K2组合键 */
static uint8_t IsKeyDown6(void) {if (IsKeyDown3() && IsKeyDown4()) return 1;else return 0;}	/* K3 K4组合键 */
#endif
...
uint8_t bsp_Read485Address(void)
{
    uint8_t temp=0xff;
    temp = GPIO_ReadInputData(GPIOF)&0x00ff;
    return ~temp;
}
