...
{	
    ...
    {		
        ...
        if((msg_p= strstr((const char *)ring_fifo.data, "+MIPL"))!=NULL&&(msg_p= strstr((const char *)ring_fifo.data, "+MIPLCREATE"))==NULL) {
...
//        else if((msg_p= strstr((const char *)ring_fifo.data, "+CCLK"))!=NULL) //add my self
//        {
