...
#define KEY_COUNT   	 	(HARD_KEY_NUM + 1)	/* 8个独立建 + 2个组合按键 */
...
static const X_GPIO_T s_gpio_list[HARD_KEY_NUM] = {
	{GPIOB, GPIO_PIN_13, 0},		/* K1 */
	{GPIOB, GPIO_PIN_14, 0},	/* K2 */
//	{GPIOB, GPIO_PIN_13, 0},		/* K3 */
//	{GPIOB, GPIO_PIN_13, 0},		/* JOY_U */	
//	{GPIOB, GPIO_PIN_13, 0},	/* JOY_D */
//	{GPIOB, GPIO_PIN_13, 0},		/* JOY_L */	
//	{GPIOB, GPIO_PIN_13, 0},		/* JOY_R */	
//	{GPIOB, GPIO_PIN_13, 0},	/* JOY_OK */
};	
